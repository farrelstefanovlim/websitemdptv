        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-20 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="aspect-[4/5] rounded-[32px] md:rounded-[48px] overflow-hidden shadow-2xl relative z-10">
                <img
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-700"
                  alt="University students collaborating"
                  src="https://i.pinimg.com/736x/75/57/f1/7557f1e58b18c5dcb21efd283e0bb48a.jpg"
                />
