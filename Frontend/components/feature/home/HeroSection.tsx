      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[80px] pt-32 pb-32">
        <div className="max-w-5xl">
          ...
          <AnimateOnScroll variant="fadeUp" delay={0.8}>
            <p className="text-base sm:text-body-lg text-white/55 mb-10 sm:mb-14 max-w-xl leading-relaxed">
              {h.description}
            </p>
          </AnimateOnScroll>
            ...
            {h.stats.map((stat, i) => (
              <div key={i} className="flex items-center gap-8 lg:gap-16">
                ...
                <div className="relative text-center sm:text-left">
                  <div className="text-2xl sm:text-4xl lg:text-5xl font-black text-white mb-1">
                    {stat.value}
                  </div>
                  <div className="text-[8px] sm:text-[10px] text-label-bold text-white/35 uppercase tracking-widest">
                    {stat.label}
                  </div>
                </div>
              </div>
