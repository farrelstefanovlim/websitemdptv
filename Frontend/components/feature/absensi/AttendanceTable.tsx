    ...
    <div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          {!isLocked && (
            <>
              ...
              >
                <Icon name="done_all" size="sm" className="!text-xs" />
              ...
              >
                <Icon name="clear_all" size="sm" className="!text-xs" />
                Clear
              </Button>
            </>
          )}
      ...
      <div className="mb-6 flex items-center gap-2 w-full">
        ...
        <div className="relative flex-1">
          <Icon name="search" size="sm" className="absolute left-3.5 top-1/2 -translate-y-1/2 text-on-surface-variant/30" />
          <input type="text" value={search} onChange={(e) => setSearch(e.target.value)}
            className="w-full h-10 pl-10 pr-4 rounded-xl border border-outline-variant/20 bg-surface-container-lowest text-sm text-primary shadow-xs focus:outline-none focus:border-secondary/40 focus:ring-2 focus:ring-secondary/10 transition-all"
