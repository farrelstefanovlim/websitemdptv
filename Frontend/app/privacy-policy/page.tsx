    ...
    <div className="min-h-screen bg-background text-on-surface relative flex flex-col">
      ...
      <main className="relative z-10 flex-1 pt-12 pb-24 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        <div className="max-w-[800px] mx-auto glass-card-light rounded-3xl p-8 sm:p-12 shadow-sm border border-outline-variant/30">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-primary mb-8 tracking-tight font-display">Privacy Policy</h1>

          <div className="text-on-surface-variant leading-relaxed space-y-6">
            <p>Di UKM MDPTV Universitas Multi Data Palembang, privasi Anda sangat penting bagi kami. Kebijakan Privasi ini menjelaskan jenis informasi pribadi yang kami terima dan kumpulkan saat Anda menggunakan situs web kami, serta beberapa langkah yang kami ambil untuk melindungi informasi tersebut.</p>

            <h2 className="text-xl font-bold text-primary mt-8 mb-4">Pengumpulan dan Penggunaan Informasi</h2>
            <p>Kami hanya akan mengumpulkan informasi pribadi Anda saat pengisian formulir pendaftaran anggota atau komunikasi melalui detail kontak yang kami sediakan. Informasi yang dikumpulkan hanya akan digunakan untuk keperluan pendataan, seleksi administrasi, dan memberikan pemberitahuan seputar kegiatan MDPTV. MDPTV tidak akan menjual, menyewakan, atau membagikan daftar informasi anggota ke pihak ketiga.</p>

            <h2 className="text-xl font-bold text-primary mt-8 mb-4">Penggunaan Karya dan Galeri</h2>
            <p>Foto-foto dan dokumentasi yang dipublikasikan pada Galeri website ini adalah milik UKM MDPTV. Setiap dokumentasi yang mencakup wajah atau karya individu telah digunakan atas nama portofolio organisasi. Jika Anda merasa terdapat kekeliruan atau ingin dokumentasi Anda dihapus, silakan hubungi tim kami.</p>

            <h2 className="text-xl font-bold text-primary mt-8 mb-4">Perubahan Kebijakan</h2>
            <p>Kebijakan Privasi ini sewaktu-waktu dapat diubah dan diperbarui. Setiap perubahan kebijakan privasi akan dicantumkan pada halaman ini. Anda diharapkan untuk sesekali memeriksa halaman ini untuk menyadari adanya perubahan.</p>

            <p className="mt-8 text-sm italic text-on-surface-variant/70">Terakhir diperbarui: 27 Mei 2024</p>
          </div>
        </div>
      </main>
